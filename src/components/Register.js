...
function Register(){
    ...
    return(
        <div className="register-admin-create-users-panel-wrapper">
            {
                !isCreated ?
                <div className="register-admin-users-panel-detail">
                <div className="register-admin-users-panel-detail-wrapper">
                    <div className="register-input-details-1">
                        <img src={imgData} alt="" />
                    </div>
                    <div className="register-input-details-2">
                        ...
                        <input type="phone" name="emailId" placeholder="Phone Number" onChange={(e)=>{setPhone(e.target.value)}}/>
            ...
            {
                isCreated ? 
                <div className="register-admin-created-wrapper">
